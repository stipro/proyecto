...
<div id="main-wrapper">
  ...
  <div class="card rounded-0">
    <div class="card-header">
      <h2><?php echo $d->title; ?> <a class="btn blue fright" id="btnAdd-md-category"><i class="fa fa-plus"></i> Agregar</a></h2>
    </div>
    <div class="card-body">
      <div id="table-head">
      ...
      <div class="wrapper_categories table-responsive">

        <?php if (empty($d->categorias->rows)) : ?>

          <div class="text-center py-5">
            <img src="<?php echo IMAGES . 'file.png'; ?>" alt="No hay registros" class="img-fluid" style="width: 120px;">
            <p class="text-muted">No hay registro de Categorias en la base de datos.</p>
          </div>
        ...
        <?php else : ?>
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <?php foreach ($d->categorias->rows as $t) : ?>
                <tr data-type="element" data-id="">
                  <td><input type="checkbox" name="chbox" value="<?php echo $t->id_categoria; ?>" /></td>
                  <td class="hover"><?php echo $t->id_categoria ?></td>
          ...
          <?php echo $d->categorias->pagination; ?>
        <?php endif; ?>
