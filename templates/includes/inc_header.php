...
<body class="<?php echo isset($d->bg) && $d->bg === 'dark' ? 'bg-dark' : 'bg-light' ?>" style="<?php echo 'padding: '.(isset($d->padding) ? $d->padding : '200px 0px'); ?>; <?php echo 'height: '.(isset($d->height) ? $d->height : '200px 0px'); ?>">
<!-- ends inc_header.php -->